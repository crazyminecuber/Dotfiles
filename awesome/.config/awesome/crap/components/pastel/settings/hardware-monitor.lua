...
return wibox.widget {
	...
	},
	{
		{
			layout = wibox.layout.fixed.vertical,
			require('widgets.glorious.cpu-meter'),
			require('widgets.glorious.cpu-meter'),
			--require('widgets.glorious.ram-meter'),
			--require('widgets.glorious.temperature-meter'),
			--require('widgets.glorious.harddrive-meter')
		},
