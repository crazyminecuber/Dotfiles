...
local central_panel = function(s)
         ...
         {
            {
               ...
               separator,
               {
                  ...
                  layout = wibox.layout.fixed.vertical,
                  {
                     ...
                     spacing = dpi(7),
                     require("widgets.glorious.notif-center")(s),
                  },
                  {
                     id = "settings_id",
                     visible = false,
                     layout = wibox.layout.fixed.vertical,
                     require("components.pastel.central-panel.settings")(),
                 },
               },
            },
            margins = dpi(16),
   ...
   s.backdrop_central:buttons(awful.util.table.join(awful.button({}, 1, nil, function()
      panel:toggle()
   end)))
   return panel
end
