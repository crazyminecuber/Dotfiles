...
naughty.connect_signal("request::display", function(n)
   ...
   if
      n.app_name ~= "xfce4-power-manager"
      and n.urgency ~= "critical"
      and (_G.dont_disturb or (focused.central_panel and focused.central_panel.visible))
   then
...
naughty.connect_signal("added", function() end)
