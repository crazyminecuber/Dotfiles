...
keys.globalkeys = gears.table.join(
   ...
   end, { description = "open clipboad manager", group = "launcher" }),
   awful.key({ modkey }, "e", function()
      awful.spawn(apps.filebrowser)
   end, { description = "Filebrowser", group = "launcher" }),
   awful.key({ modkey }, "v", function()
      print("gurk")
      awful.spawn(apps.neovim)
   end, { description = "Neovim", group = "launcher" }),
   ...
   end, { description = "Prompt for screenshot and perform ocr", group = "hotkeys" }),
   awful.key({ modkey }, "b", function()
      awful.spawn(apps.beats)
   end, { description = "Rofi beats", group = "hotkeys" }),
   ...
   awful.key({ modkey }, "x", function()
      awful.spawn.easy_async('rofi -p "Enter lua code" -dmenu', function(stdout, stderr, reason, exit_code)
         naughty.notification({ text = stdout })
         awful.util.eval(stdout)
