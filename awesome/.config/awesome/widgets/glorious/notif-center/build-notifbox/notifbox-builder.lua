...
local builder = require("widgets.glorious.notif-center.build-notifbox.notifbox-ui-elements")
local notifbox_core = require("widgets.glorious.notif-center.build-notifbox")
...
notifbox_box = function(notif, icon, title, message, app, bgcolor)
   ...
   notifbox:buttons(gears.table.join(awful.button({}, 1, function()
