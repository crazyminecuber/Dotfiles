...
local widget_icon_dir = config_dir .. 'icons/notif-center/'

local empty_notifbox = require('widgets.glorious.notif-center.build-notifbox.empty-notifbox')
local notifbox_scroller = require('widgets.glorious.notif-center.build-notifbox.notifbox-scroller')
...
local notifbox_add = function(n, notif_icon, notifbox_color)
	...
	local notifbox_box = require('widgets.glorious.notif-center.build-notifbox.notifbox-builder')
