...
--vim.cmd([[highlight IndentBlanklineContextChar guibg=#3e4451 guifg=#00FF00 gui=nocombine]])
--vim.cmd([[highlight IndentBlanklineContextChar guibg=#3e4451  gui=nocombine]])
